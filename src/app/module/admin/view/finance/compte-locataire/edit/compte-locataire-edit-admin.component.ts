...
@Component({
  selector: 'app-compte-locataire-edit-admin',
  standalone: false,
  templateUrl: './compte-locataire-edit-admin.component.html'
})
export class CompteLocataireEditAdminComponent implements OnInit {
