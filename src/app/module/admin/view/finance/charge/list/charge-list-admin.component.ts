...
@Component({
  selector: 'app-charge-list-admin',
  standalone: false,
  templateUrl: './charge-list-admin.component.html'
})
export class ChargeListAdminComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.loadTypeCharge();
        this.loadLocal();
        this.yesOrNoIsPaid =  [{label: 'IsPaid', value: null},{label: 'Oui', value: 1},{label: 'Non', value: 0}];
    ...
    public async edit(dto: ChargeDto) {
    ...
    public async view(dto: ChargeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ChargeDto) {
    ...
    public async duplicate(dto: ChargeDto) {
    ...
    public exportPdf(dto: ChargeDto): void {
...
// add
    ...
    public async loadTypeCharge(){
        this.typeChargeService.findAllOptimized().subscribe(typeCharges => this.typeCharges = typeCharges, error => console.log(error))
    }
	...
	public initDuplicate(res: ChargeDto) {
	}
    ...
    get selections(): Array<ChargeDto> {
        return this.service.selections;
    }

    set selections(value: Array<ChargeDto>) {
