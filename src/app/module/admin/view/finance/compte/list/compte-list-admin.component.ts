...
export class CompteListAdminComponent implements OnInit {

    protected fileName = 'Compte';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CompteDto>();
    ...
    public async duplicate(dto: CompteDto) {
    ...
    public exportPdf(dto: CompteDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'banque?.label', header: 'Banque'},
        ];
    }
	...
	public initDuplicate(res: CompteDto) {
        if (res.transactions != null) {
             res.transactions.forEach(d => { d.compteSource = null; d.id = null; });
        }
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            ...
            this.criteriaData = [{
                ...
                'Numero compte Min': this.criteria.numeroCompteMin ? this.criteria.numeroCompteMin : environment.emptyForExport ,
                'Numero compte Max': this.criteria.numeroCompteMax ? this.criteria.numeroCompteMax : environment.emptyForExport ,
            ...
            //'Banque': this.criteria.banque?.label ? this.criteria.banque?.label : environment.emptyForExport ,
            }];
			}
    ...
    get selections(): Array<CompteDto> {
        return this.service.selections;
    }

    set selections(value: Array<CompteDto>) {
