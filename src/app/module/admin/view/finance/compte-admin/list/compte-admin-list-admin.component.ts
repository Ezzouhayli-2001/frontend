...
@Component({
  selector: 'app-compte-admin-list-admin',
  standalone: false,
  templateUrl: './compte-admin-list-admin.component.html'
})
export class CompteAdminListAdminComponent implements OnInit {

    protected fileName = 'CompteAdmin';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CompteAdminDto>();
    ...
    public async edit(dto: CompteAdminDto) {
    ...
    public async view(dto: CompteAdminDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CompteAdminDto) {
    ...
    public async duplicate(dto: CompteAdminDto) {
    ...
    public exportPdf(dto: CompteAdminDto): void {
...
// add
	...
	public initDuplicate(res: CompteAdminDto) {
        if (res.comptes != null) {
             res.comptes.forEach(d => { d.transactions = null; d.id = null; });
        }
	}
    ...
    get selections(): Array<CompteAdminDto> {
        return this.service.selections;
    }

    set selections(value: Array<CompteAdminDto>) {
