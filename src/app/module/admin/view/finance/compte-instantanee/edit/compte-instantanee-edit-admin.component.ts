...
@Component({
  selector: 'app-compte-instantanee-edit-admin',
  standalone: false,
  templateUrl: './compte-instantanee-edit-admin.component.html'
})
export class CompteInstantaneeEditAdminComponent implements OnInit {
