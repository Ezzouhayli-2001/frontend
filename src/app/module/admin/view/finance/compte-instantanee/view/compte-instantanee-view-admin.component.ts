...
@Component({
  selector: 'app-compte-instantanee-view-admin',
  standalone: false,
  templateUrl: './compte-instantanee-view-admin.component.html',
    styleUrls: ['./compte-instantanee-view-admin.component.scss']
})
export class CompteInstantaneeViewAdminComponent implements OnInit {
