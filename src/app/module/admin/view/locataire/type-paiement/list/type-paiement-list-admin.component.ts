...
export class TypePaiementListAdminComponent implements OnInit {

    protected fileName = 'TypePaiement';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TypePaiementDto>();
    ...
    public async edit(dto: TypePaiementDto) {
    ...
    public async view(dto: TypePaiementDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TypePaiementDto) {
    ...
    public async duplicate(dto: TypePaiementDto) {
    ...
    public exportPdf(dto: TypePaiementDto): void {
...
// add
    ...
    get selections(): Array<TypePaiementDto> {
        return this.service.selections;
    }

    set selections(value: Array<TypePaiementDto>) {
