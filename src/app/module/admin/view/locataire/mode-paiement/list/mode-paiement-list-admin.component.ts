...
export class ModePaiementListAdminComponent implements OnInit {

    protected fileName = 'ModePaiement';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ModePaiementDto>();
    ...
    public async edit(dto: ModePaiementDto) {
    ...
    public async view(dto: ModePaiementDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ModePaiementDto) {
    ...
    public async duplicate(dto: ModePaiementDto) {
    ...
    public exportPdf(dto: ModePaiementDto): void {
...
// add
    ...
    get selections(): Array<ModePaiementDto> {
        return this.service.selections;
    }

    set selections(value: Array<ModePaiementDto>) {
