...
@Component({
  selector: 'app-type-locataire-view-admin',
  standalone: false,
  templateUrl: './type-locataire-view-admin.component.html'
})
export class TypeLocataireViewAdminComponent implements OnInit {
    ...
    constructor(private service: TypeLocataireAdminService){
