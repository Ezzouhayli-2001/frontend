...
@Component({
  selector: 'app-location-edit-admin',
  standalone: false,
  templateUrl: './location-edit-admin.component.html'
})
export class LocationEditAdminComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.CompteInstantaneeService.findAll().subscribe((data) => this.CompteInstantanees = data);
 ...
 public edit(): void {
   ...
   public async openCreateTransaction(transaction: string) {
        const isPermistted = await this.roleService.isPermitted('Transaction', 'edit');
        if (isPermistted) {
   ...
   public async openCreateLocataire(locataire: string) {
        const isPermistted = await this.roleService.isPermitted('Locataire', 'edit');
        if (isPermistted) {
   ...
   public async openCreateTypePaiement(typePaiement: string) {
    ...
    get createCompteInstantaneeDialog(): boolean {
        return this.CompteInstantaneeService.createDialog;
    }
    set createCompteInstantaneeDialog(value: boolean) {
        this.CompteInstantaneeService.createDialog= value;
    }
