...
@Component({
  selector: 'app-reglement-view-admin',
  standalone: false,
  templateUrl: './reglement-view-admin.component.html'
})
export class ReglementViewAdminComponent implements OnInit {
    ...
    constructor(private service: ReglementAdminService, private locationService: LocationAdminService){
