...
@Component({
  selector: 'app-locataire-list-admin',
  standalone: false,
  templateUrl: './locataire-list-admin.component.html'
})
export class LocataireListAdminComponent implements OnInit {

    protected fileName = 'Locataire';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<LocataireDto>();
    ...
    public async edit(dto: LocataireDto) {
    ...
    public async view(dto: LocataireDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: LocataireDto) {
    ...
    public async duplicate(dto: LocataireDto) {
    ...
    public exportPdf(dto: LocataireDto): void {
...
// add
	...
	public initDuplicate(res: LocataireDto) {
	}
    ...
    get selections(): Array<LocataireDto> {
        return this.service.selections;
    }

    set selections(value: Array<LocataireDto>) {
