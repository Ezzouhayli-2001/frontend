...
@Component({
  selector: 'app-avoir-list-admin',
  standalone: false,
  templateUrl: './avoir-list-admin.component.html'
})
export class AvoirListAdminComponent implements OnInit {

    protected fileName = 'Avoir';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<AvoirDto>();
    ...
    public async edit(dto: AvoirDto) {
    ...
    public async view(dto: AvoirDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: AvoirDto) {
    ...
    public async duplicate(dto: AvoirDto) {
    ...
    public exportPdf(dto: AvoirDto): void {
...
// add
	...
	public initDuplicate(res: AvoirDto) {
	}
    ...
    get selections(): Array<AvoirDto> {
        return this.service.selections;
    }

    set selections(value: Array<AvoirDto>) {
