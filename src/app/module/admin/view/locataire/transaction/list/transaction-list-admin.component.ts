...
export class TransactionListAdminComponent implements OnInit {

    protected fileName = 'Transaction';
    ...
    compteSources: Array<CompteDto>;
    compteDestinations: Array<CompteDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<TransactionDto>();
    ...
    public async edit(dto: TransactionDto) {
    ...
    public async view(dto: TransactionDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: TransactionDto) {
    ...
    public async duplicate(dto: TransactionDto) {
    ...
    public exportPdf(dto: TransactionDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'modePaiement?.label', header: 'Mode paiement'},
            {field: 'typePaiement?.label', header: 'Type paiement'},
            {field: 'compteSource?.id', header: 'Compte source'},
            {field: 'compteDestination?.id', header: 'Compte destination'},
        ];
    }
    ...
    public async loadCompteSource(){
        this.compteService.findAll().subscribe(compteSources => this.compteSources = compteSources, error => console.log(error))
    }
    public async loadCompteDestination(){
        this.compteService.findAll().subscribe(compteDestinations => this.compteDestinations = compteDestinations, error => console.log(error))
    }


	public initDuplicate(res: TransactionDto) {
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						...
						'Compte source': e.compteSource?.id ,
						'Compte destination': e.compteDestination?.id ,
					}
				});
            ...
            //'Mode paiement': this.criteria.modePaiement?.label ? this.criteria.modePaiement?.label : environment.emptyForExport ,
            //'Type paiement': this.criteria.typePaiement?.label ? this.criteria.typePaiement?.label : environment.emptyForExport ,
            //'Compte source': this.criteria.compteSource?.id ? this.criteria.compteSource?.id : environment.emptyForExport ,
            //'Compte destination': this.criteria.compteDestination?.id ? this.criteria.compteDestination?.id : environment.emptyForExport ,
            }];
			}
    ...
    get selections(): Array<TransactionDto> {
        return this.service.selections;
    }

    set selections(value: Array<TransactionDto>) {
