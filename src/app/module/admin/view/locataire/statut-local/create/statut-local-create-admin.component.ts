...
@Component({
  selector: 'app-statut-local-create-admin',
  standalone: false,
  templateUrl: './statut-local-create-admin.component.html'
})
export class StatutLocalCreateAdminComponent  implements OnInit {
