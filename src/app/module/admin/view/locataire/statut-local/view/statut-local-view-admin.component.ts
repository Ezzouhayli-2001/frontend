...
@Component({
  selector: 'app-statut-local-view-admin',
  standalone: false,
  templateUrl: './statut-local-view-admin.component.html'
})
export class StatutLocalViewAdminComponent implements OnInit {
    ...
    constructor(private service: StatutLocalAdminService){
